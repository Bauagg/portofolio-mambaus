                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col gap-6 text-center md:text-left items-center md:items-start">
                        ...
                        <div className="flex flex-row gap-4 mt-4">
                            ...
                            <button className="px-4 sm:px-8 py-3 bg-white border-[#212529] text-[#212529] font-medium border-2 rounde rounded flex justify-between items-center gap-2 sm:gap-3 cursor-pointer text-sm sm:text-base"
                                style={{ boxShadow: '4px 4px 0px #212529' }}>
