...
export default function Onbording() {
    ...
    return (
        <section id="home" className="min-h-screen bg-white dark:bg-black pt-24 md:pt-32">
                    ...
                    <div className="flex flex-col gap-6 text-center md:text-left items-center md:items-start">
                        ...
                        <div className="flex flex-row gap-4 mt-4">
                            <button
                                ...
                                className="px-4 sm:px-8 py-3 bg-[#212529] border-white text-white font-medium border-2 rounde rounded flex justify-between items-center gap-2 sm:gap-3 cursor-pointer text-sm sm:text-base"
                                style={{ boxShadow: '4px 4px 0px #212529' }}>
                                {language === 'ENG' ? 'Download CV' : 'Unduh CV'}

                                <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                            ...
                            <a
                                href="#contact"
                                className="px-4 sm:px-8 py-3 bg-white border-[#212529] text-[#212529] font-medium border-2 rounde rounded flex justify-between items-center gap-2 sm:gap-3 cursor-pointer text-sm sm:text-base hover:bg-gray-50 transition-colors"
                                style={{ boxShadow: '4px 4px 0px #212529' }}
                            >
